...
.DESCRIPTION
    ...
    src/main.rs. Scenes: menu, warren, mine, blacksmith, equipment, factory, famine, raid, breeding, worm.
...
#>
param(
    [string[]]$Scenes = @("menu", "warren", "mine", "blacksmith", "equipment", "factory", "famine", "raid", "breeding", "worm"),
    [int]$Frames = 150,
